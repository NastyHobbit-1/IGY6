...
and existing pattern, hypothesis, prediction, and recommendation records. It
does not create sources, run collection, upload files, normalize content,
generate chunks, create evidence, approve actions, generate chat answers,
