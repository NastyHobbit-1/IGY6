...
Landed on origin: this record; `nightly_tasks.md`; `docs/WORKING.md` and `docs/ui/README.md` verifier notes.
...
PUT size in this agent path (same constraint DIFF-309/314 recorded):
...
Complete the leftover origin landings DIFF-314 recorded, on lowercase `grok`
only, without editing locked DIFF-308 through DIFF-314.
...
- Land the leftover origin blobs DIFF-314 listed when the PUT path can carry them.
