...
Landed on origin: this record; `nightly_tasks.md`; `docs/ui/README.md` verifier
note; product-smoke kept origin-green (no new markers that origin HomePage
cannot satisfy).
...
PUT size in this agent path (same constraint DIFF-309/316 recorded):
...
only, without editing locked DIFF-308 through DIFF-316.
...
- Land the leftover origin blobs DIFF-316 listed when the PUT path can carry them.
