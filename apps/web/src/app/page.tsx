    ...
    <section className="panel entityClaimEventFoundation" data-entity-claim-event-foundation>
      <div className="panelHeader">
        <div>
          ...
          <h2>Entity, Claim, And Event Review</h2>
        </div>
        <StatusPill state="review-foundation" />
      </div>
      <div className="guidedManualNotice">
        <strong>Evidence-tied review only.</strong>
        <span>This surface derives conservative review candidates from local text evidence and existing claim records. It does not mutate evidence, resolve identities, run hosted AI, claim full NLP extraction, or claim full graph reasoning.</span>
      </div>
      ...
      <p className="messageMeta">Current gateway support exposes claim reads only; entity/event persistence and claim creation remain future scoped work. Safe next action: review candidates against the source/evidence detail panels before relying on them.</p>
    </section>
  );
}
